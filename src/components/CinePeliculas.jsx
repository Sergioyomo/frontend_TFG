...
import { Grid, Card, CardContent, Container, Typography, CardMedia, Button } from "@mui/material";

function CinePeliculas() {
  ...
  useEffect(() => {
    ...
    async function getPelicula() {
      let response = await fetch(apiUrl + "/pelicula?cine="+params.idCine);
        ...
        <Grid item xs={12} sm={6} md={4} lg={3} key={pelicula.id}>
          ...
          <CardMedia
            ...
            <CardContent sx={{ textAlign: "center" }}>
              ...
              <Button
                  variant="contained"
                  onClick={() => navigate("/pelicula/"+pelicula.id_sala+"/" + pelicula.id)}
